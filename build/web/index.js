...
var ASM_CONSTS = {
  156536: () => { if (document.fullscreenElement) return 1; },  
 156582: () => { return document.getElementById('canvas').width; },  
 156634: () => { return parseInt(document.getElementById('canvas').style.width); },  
 156702: () => { document.exitFullscreen(); },  
 156729: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 156802: () => { if (document.fullscreenElement) return 1; },  
 156848: () => { return document.getElementById('canvas').width; },  
 156900: () => { return screen.width; },  
 156925: () => { document.exitFullscreen(); },  
 156952: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 157085: () => { return window.innerWidth; },  
 157111: () => { return window.innerHeight; },  
 157138: () => { if (document.fullscreenElement) return 1; },  
 157184: () => { return document.getElementById('canvas').width; },  
 157236: () => { return parseInt(document.getElementById('canvas').style.width); },  
 157304: () => { if (document.fullscreenElement) return 1; },  
 157350: () => { return document.getElementById('canvas').width; },  
 157402: () => { return screen.width; },  
 157427: () => { return window.innerWidth; },  
 157453: () => { return window.innerHeight; },  
 157480: () => { if (document.fullscreenElement) return 1; },  
 157526: () => { return document.getElementById('canvas').width; },  
 157578: () => { return screen.width; },  
 157603: () => { document.exitFullscreen(); },  
 157630: () => { if (document.fullscreenElement) return 1; },  
 157676: () => { return document.getElementById('canvas').width; },  
 157728: () => { return parseInt(document.getElementById('canvas').style.width); },  
 157796: () => { document.exitFullscreen(); },  
 157823: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 157881: () => { return screen.width; },  
 157906: () => { return screen.height; },  
 157932: () => { return window.screenX; },  
 157959: () => { return window.screenY; },  
 157986: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 158039: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 158110: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 158167: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 158423: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 158494: () => { if (document.fullscreenElement) return 1; },  
 158540: () => { return window.innerWidth; },  
 158566: () => { return window.innerHeight; },  
 158593: () => { if (document.pointerLockElement) return 1; }
};
